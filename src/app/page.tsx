    ...
    <div className="space-y-8">
      <section className="text-center space-y-3">
        ...
        <p className="text-zinc-600 dark:text-zinc-300">
          We filter for 4+ star ratings, sort by review count ascending, and feature
          the product with the most reviews last as our <span className="font-semibold">TOP PICK</span>.
        </p>
      </section>
